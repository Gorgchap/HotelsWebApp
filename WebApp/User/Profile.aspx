<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="WebApp.Profile" %>
            ...
            <div class="col-10 offset-1 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-4 offset-lg-4">
                ...
                <form runat="server" class="card p-3">
                    ...
                    <div class="mt-3" style="display: flex; justify-content: center; align-items: center">
                        <asp:Button runat="server" ID="Change" Text="Change" CssClass="btn btn-primary"/>
