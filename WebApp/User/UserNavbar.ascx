...
<nav class="navbar navbar-expand bg-dark navbar-dark fixed-top">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item">
            <a class="nav-link" href="Hotels.aspx">Hotels</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div class="dropdown-menu dropdown-menu-right bg-dark" style="margin-top: -0.75rem">
                <a class="dropdown-item text-white" onmouseover="this.style.background='#5f6a75'" onmouseout="this.style.background='#343a40'" href="Profile.aspx">Profile</a>
